...
export default function WelcomeScreen1() {
    ...
    return (
        <View style={styles.container}>
            ...
            {/* Основной контент */}
            <View style={[styles.content,{ position: 'absolut' }]}>
                ...
                <View>
                <Text style={styles.mainTitle}>Трекер вашего чтения</Text>
                <View style={styles.textBlock}>
                    <Text style={[ styles.subtitleText, { marginTop: -30 }]}>Добро пожаловать в</Text>
                    <Text style={styles.subtitleText}>читательский мир!</Text>
                </View >
                <View style={styles.textBlock}>
                    <TouchableOpacity
                        style={[styles.registerButton, styles.primaryButton, { marginTop: -30 }]}
                        onPress={() => navigation.navigate('WelcomeScreen2')}
                    >
                        <Text style={styles.actionText}>Давай узнаем</Text>
                    </TouchableOpacity>
